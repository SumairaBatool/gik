<?php require_once("../inlcudes/config.php");
  //  print_r($_SESSION);die;
//  if ($_SESSION['userInfo']['options']->user_role != '1' ) {
...
<body>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../imgs\kaneez-fatima.jpeg" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar" style="background-color:rgb(128, 128, 128);">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="user-admissions.php">
          <i class="bi bi-person"></i>
