            ...
            <div class="row" style="">
                ...
                <div class=" col-sm-12 col-md-3" style="" class="custom-css-footer">
                    ...
                    <ol class="link-link">
                        ...
                        <li class="custom-list">
                            <a href="pages/courses.php" class="footer-items">Hafz ul Quran</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/courses.php" class="footer-items">Makriem Ikhlaq</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/courses.php" class="footer-items">Dars E Hadith</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/courses.php" class="footer-items">Pand Nama</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/courses.php" class="footer-items">Tarjuma and Tafseer</a>
                        </li>
                    </ol>
                </div>
                <div class="col-sm-12 col-md-3" style="" class="custom-css-footer">
                    ...
                    <ol class="link-link">
                        ...
                        <li class="custom-list">
                            <a href="pages/Donations.php" class="footer-items">About Us</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/Faculty.php" class="footer-items">Our Faculty</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/gallery.php" class="footer-items">Gallery</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/Donations.php" class="footer-items">FAQ's</a>
                        </li>
                        <li class="custom-list">
                            <a href="index.php" class="footer-items">Privacy Policy</a>
                        </li>
                        <li class="custom-list">
                            <a href="pages/contact_us.php" class="footer-items">Contact Us</a>
                        </li>
                    </ol>
                </div>
                <div class="col-sm-12 col-md-3" style="" class="custom-css-footer">
...
<script type="text/javascript"
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBOaSmNcBHf07FWaVlO4pXgyFYMjmCPAEg"></script>
<script type="text/javascript"
    src="<?= url()?>assets/MapIt-master/MapIt-master/demo/javascripts/vendor/jquery.mapit.min.js"></script>
<script src="<?= url()?>assets/MapIt-master/MapIt-master/demo/javascripts/initializers.js"></script>
<script src="<?= url()?>js/jquery.scrollUp.min.js"></script>

<!-- my jquery -->
<script src="<?= url()?>js/admission.js"></script>
