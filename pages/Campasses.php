...
<head>
    ...
    <link rel="stylesheet" href="../CSS/Campasses.css">
    <!-- font awesome link -->
...
<body>
    ...
    <header>
        <div class="container-fluid p-4 custom-container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-8 order-sm-3 order-lg-2  custom-col " id="forrespo">
                    <li><a href="#">SATELITE TOWN SKARDU, STREET NO-2</a></li><br>
                    <div id="hidethis">
                        <li><a href="#">+921818999872</a></li>
                    </div>
                    <li><a href="#">SATUARDY-THHRUSDAY:5:00AM-3:00PM</a></li><br>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="breatcome_title">
                            <div class="breatcome_title_inner pb-2">
                                <h2 style="text-transform: uppercase;">wellcome on campus page</h2>
                            </div>
                            <div class="breatcome_content">
                                <ul>
                                    <li><a href="../index.html">Home</a> <i class="fa fa-angle-right"></i>
                                        <a href="Campasses.php">Campus</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <h3 class="text-center text-uppercase margin-padding">Our Campus In Different Cities</h3>
    <p class="text-center-para">Amazing sequence view of our different campus thats in different cities in Pakistan</p>
    <div class="container-fluid">
        <div class="row">
                <div class="camp_image">
                    <h2>Khaplu</h2>
                    <p>Our campus in khaplu braqchan was build in 1998.Almost 80 student get education of different courses.
                    </p>
                    <img src="../imgs/khaplu.jpg" alt="">
                </div>
                <div class="camp_image">
                    <h2>Islamabad</h2>
                    <p>Our campus in Islamabad center was build in 1996.Almost 120 student get education of different courses.
                    </p>
                    <img src="../imgs/islamabad.webp" alt="">
                </div>
                <div class="camp_image">
                    <h2>Pindi</h2>
                    <p>Our campus in RawalPindichakari road was build in 1994.Almost 220 student get education of different courses.
                    </p>
                    <img src="../imgs/pindi.jpg" alt="">
                </div>

                <div class="camp_image">
                    <h2>Karachi</h2>
                    <p>Our campus in Karachi Mangupeer was build in 1994.Almost 320 student get education of different courses.
                    </p>
                    <img src="../imgs/karachi.jpg" alt="">
                </div>
                <div class="camp_image">
                    <h2>Lahore</h2>
                    <p>Our campus in Lahore center was build in 1990.Almost 300 student get education of different courses.
                    </p>
                    <img src="../imgs/lahore.webp" alt="">
                </div>
                <div class="camp_image">
                    <h2>Gilgit</h2>
                    <p>Our campus in Gilgit center was build in 1980.Almost 580 student get education of different courses.
                    </p>
                    <img src="../imgs/gilgit.jpg" alt="">
                </div>
        </div>
</section>
        <!-- footer -->
