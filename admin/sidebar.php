<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="subject"><a href="./course.php"><i class="fa fa-book"></i> <span>Course</span> </a></li>
        ...
        <li id="subject"><a href="./new-admissions.php"><i class="fa fa-book"></i> <span>New admissions</span> </a></li>
      ...
      <li id="notice-role"><a href="./notice-role.php"><i class="fa fa-envelope-o"></i> <span>Notice</span> </a></li>
      <li id="notice-role"><a href="./new-admissions.php"><i class="fa fa-envelope-o"></i> <span>My Course</span> </a></li>
