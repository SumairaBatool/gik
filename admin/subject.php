          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group">
                <label>Course</label>
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="classroom"  required><option >Select Course</option>
                  <?php
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                  echo "<option "; if($classroom==$row["cno"]){echo 'selected="selected"';} echo " value='".$row["hno"]."' >".$row["title"]."_ID:".$row["hno"]."</option>";
                       }
                        }
                  ?>
                </select>
